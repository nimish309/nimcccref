...
/**
 * Created by prashant.dodia on 10/12/2015.
 */
public class CustomeDateAndTimePicker implements View.OnClickListener {
    ...
    public CustomeDateAndTimePicker(Activity a,
