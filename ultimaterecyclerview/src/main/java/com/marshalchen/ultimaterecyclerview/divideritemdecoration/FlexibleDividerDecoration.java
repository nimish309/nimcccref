...
public abstract class FlexibleDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public static class Builder<T extends Builder> {
        ...
        public T colorResId(@ColorRes int colorId) {
            return color(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ? mContext.getColor(colorId) : mResources.getColor(colorId));
        }
        ...
        public T drawable(@DrawableRes int id) {
            return drawable(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ? mContext.getDrawable(id) : mResources.getDrawable(id));
        }
