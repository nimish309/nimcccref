...
public class FloatingActionButton extends ImageButton {
    ...
    int getColor(@ColorRes int id) {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ? getContext().getColor(id) : getResources().getColor(id);
    }
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ?
                                getContext().getDrawable(mSize == SIZE_NORMAL ? R.drawable.urv_floating_action_button_fab_bg_normal : R.drawable.urv_floating_action_button_fab_bg_mini) :
    ...
    Drawable getIconDrawable() {
        if (mIcon != 0) {
            return Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ?
                    getContext().getDrawable(mIcon) : getResources().getDrawable(mIcon);
        } else {
