...
public abstract class DragDropTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    public DragDropTouchListener(RecyclerView recyclerView, Activity activity) {
        ...
        this.dragHighlight = Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP ?
                recyclerView.getContext().getDrawable(R.drawable.drag_frame) : recyclerView.getResources().getDrawable(R.drawable.drag_frame);
